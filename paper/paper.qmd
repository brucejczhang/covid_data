---
title: "COVID-19 Cases and Deaths in Canada in 2022 By Region, Age, and Sex"
...
#| fig-cap: Predicted probability of high risk of COVID-19 by region (Urban vs. Rural). The density of probabilities of high risk shows that the extremes of predicted probability of high risk are more frequent for both urban and rural regions. 
#| echo: false
#| warning: false
#| message: false
#| results: 'hide'
...
```{r}
#| label: fig-model_sex
#| fig-cap: Predicted probability of high risk based on sex. The median value of the predicted probability of high risk is shown to be similar for males and females. There is a large IQR for both. 
#| echo: false
#| warning: false
#| message: false
#| results: 'hide'
